...
`);
export type CallerId = z.output<typeof CallerIdSchema>;
...
`);
export type WithKind = z.output<typeof WithKindSchema>;

const literalSchema = z.union([z.string(), z.number(), z.boolean(), z.null()]);
type Literal = z.output<typeof literalSchema>;
...
export type ContextKind = z.output<typeof ContextKindSchema>;
