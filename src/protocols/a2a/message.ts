...
export type MessageSendConfiguration = z.output<typeof MessageSendConfigurationSchema>;
...
export const isMessageSendParams = (input: unknown): input is MessageSendParams => {
    return MessageSendParamsSchema.safeParse(input).success;
};
...
export type SendMessageSuccessResult = z.output<typeof SendMessageSuccessResultSchema>;
/**
 * @description JSON-RPC success response model for the 'message/send' method.
 */
export const SendMessageSuccessResponseSchema = JSONRPCResultResponseSchema.extend({
    /**
...
export type SendMessageSuccessResponse = z.output<typeof SendMessageSuccessResponseSchema>;

/**
 * @description JSON-RPC response model for the 'message/send' method.
 */
export const SendMessageResponseSchema = z.union([SendMessageSuccessResponseSchema, JSONRPCErrorResponseSchema]);
...
export type SendStreamingMessageRequest = z.output<typeof SendStreamingMessageRequestSchema>;
/**
...
export const SendStreamingMessageSuccessResultSchema = z
    .discriminatedUnion('kind', [MessageSchema, TaskSchema, TaskStatusUpdateEventSchema, TaskArtifactUpdateEventSchema])
    .describe(
        'The result of a streaming message request, which can be a Message, Task, or a streaming update/artifact event.',
    );
export type SendStreamingMessageSuccessResult = z.output<typeof SendStreamingMessageSuccessResultSchema>;
/**
 * @description Represents a successful JSON-RPC response for the `message/stream` method.
 * The server may send multiple response objects for a single request.
 */
export const SendStreamingMessageSuccessResponseSchema = JSONRPCResultResponseSchema.extend({
    /**
...
export type SendStreamingMessageSuccessResponse = z.output<typeof SendStreamingMessageSuccessResponseSchema>;
...
export const SendStreamingMessageResponseSchema = z
    .union([SendStreamingMessageSuccessResponseSchema, JSONRPCErrorResponseSchema])
    .describe('Response to a streaming task operation, either through `message/stream` or a subscription.');
export type SendStreamingMessageResponse = z.output<typeof SendStreamingMessageResponseSchema>;
