...
// import { TaskStatusSchema as MCPTaskStatusSchema } from '@modelcontextprotocol/sdk/types.js';
/**
...
export type GetTaskSuccessResponse = z.output<typeof GetTaskSuccessResponseSchema>;
...
export type TaskResubscriptionRequest = z.output<typeof TaskResubscriptionRequestSchema>;
 ...
 */
export const CancelTaskSuccessResponseSchema = JSONRPCResultResponseSchema.extend({
    result: TaskSchema.describe(
        'The result of the request, which can be a direct reply Message or the initial Task object.',
    ),
}).describe("JSON-RPC success response model for the 'tasks/cancel' method.");
export type CancelTaskSuccessResponse = z.output<typeof CancelTaskSuccessResponseSchema>;
